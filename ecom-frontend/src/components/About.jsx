...
const products = [
    {
        image: "https://media.istockphoto.com/id/1371695315/photo/iphone-13-pro-sierra-blue.jpg?s=612x612&w=0&k=20&c=-0Mr9DdIRHFoLUozdltlHdkum0ChCNTGfLhxc-3oHmI=",
      ...
      {
        image: "https://www.dxomark.com/wp-content/uploads/medias/post-73433/galaxys21_ultra-2048x1536-1.jpg",
      ...
      {
        image: "https://cdn.beebom.com/mobile/2024/05/Untitled-design-24.png",
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
           ...
           <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                ...
                <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTt1ZYFPzkdoZoCN7CRWUXMDAiQOhb4GP1g2w&s"
                        alt="About Us"
