...
import com.ecommerece.project.payload.*;
import com.ecommerece.project.service.OrderService;
import com.ecommerece.project.service.StripeService;
...
public class OrderController {
    ...
    public ResponseEntity<OrderResponse> getAllSellerOrders(
        ...
        OrderResponse orderResponse=orderService.getSellerAllOrders(pageNumber,pageSize,sortBy,sortOrder);
        return new ResponseEntity<>(orderResponse,HttpStatus.OK);
    }
